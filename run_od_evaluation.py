...
from object_detection.detectors import yolo_detector, yoloe_detector, yolo_yoloe_detector #, detr_detector  # (detr_detector might be used later)
...
def select_detector(model_name):
    if model_name.lower() in ["yolo11", "yolo9"]:
        ...
        return yoloe_detector.YOLOEDetector(model_name) # yolo_yoloe_detector.YOLOYOLoEDetector(model_name)
...
def main():
    ...
    # # for weights in ["Albatross-v0.4.pt"]:
