...
from object_detection.external_libraries.review_object_detection_metrics.src.utils.enumerators import BBType, BBFormat, CoordinatesType, MethodAveragePrecision, CoordinatesType
from object_detection.external_libraries.review_object_detection_metrics.src.utils import converter

def compute_pascalvoc_metrics(predictions_dir, ground_truth_dir, iou_threshold=0.5, method=MethodAveragePrecision.EVERY_POINT_INTERPOLATION):
    """
